...
if($result_rating = mysqli_query($link, "SELECT commentRating FROM e107_game_comment where postID=".$gameID)){
	...
	$userReviewCount = mysqli_num_rows($result_rating);
        ...
        }//end $userReviewCount mysqli_num_rows

}//end if $result_rating
                        ...
                        <div class="playersBox_right">
                            ...
                            <div class="playersScrollbar">
                                ...
                                <div class="container">
                                    ...
                                    <div class="skills"  data-width="7" style="width: <?php echo $commentPercentage;?>%;">7 (<?php echo $numberCommentsNum;?>)</div>
    ...
    if($result_check > 0){
        ...
        while($row = mysqli_fetch_array($result)){
            ...
            if (strlen($commentPost) > 500) {
                ...
                $commentPost .= ?>... <a href="<?php echo $userReviewURL; ?>">Read More</a><?php;
